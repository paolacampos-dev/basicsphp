<!-- 
FizzBuzz Challenge
FizzBuzz is a popular challenge for all types of programming languages.
It is a simple challenge that tests your ability to use control structures.
You will use loops and conditionals to solve this challenge.
...
• You can add <br> tags to add a line break after each number.
-->
