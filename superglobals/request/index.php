<!-- Better to use get and post instead of request which if it is mixed with get & post can open to vulnerabilities -->

<?php
echo $_REQUEST['name'] ?? ''; // does the same as get & post (changing POST 4 REQUEST) but makes the code unclear not knowing if we are getting or posting data
